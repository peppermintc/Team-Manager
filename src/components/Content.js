    ...
    <Paper className={classes.paper}>
      ...
      <div className={classes.contentWrapper}>
        <Typography color="textSecondary" align="center">
          <List>
            <ListItem button style={{ display:'grid', gridTemplateColumns: '1fr 1fr 10fr 1fr 4fr 1fr', textAlign: 'center' }} onClick={handleClick0}>
              <div>11</div>
            ...
            <ListItem button style={{ display:'grid', gridTemplateColumns: '1fr 1fr 10fr 1fr 4fr 1fr', textAlign: 'center' }} onClick={handleClick1}>
              <div>11</div>
              <img style={{ height: '52px', border: '2.5px solid black' }} src="http://demo.themeboy.com/football-club-soccer/wp-content/uploads/sites/34/sportspress-soccer-player-4-300x300.jpg"/>
              <div style={{ textAlign: 'left', paddingLeft:'20px' }}>Mack Villarreal</div>
              <div>FW</div>
